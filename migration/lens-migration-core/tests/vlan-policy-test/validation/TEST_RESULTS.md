...
## 测试汇总（2026-03-07，三模型对比）

| Provider | 模型 | 轮次 | Tokens | 延迟 | **吞吐量** | 套件耗时 | 测试结果 |
|---|---|:---:|---:|---:|---:|---:|:---:|
| GitHub Models | gpt-4o-mini | **1** | 2848 | 4852ms | **587 tokens/s** | — | **20/20** ✅ |
| Ollama (RTX 4090) | qwen2.5-coder:14b | **1** | 2974 | **15944ms** | **186.5 tokens/s** | **21.9s** | **21/21** ✅ |
| Ollama (RTX 4090) | qwen3.5:35b | **1** | 3191 | 47788ms | 66.8 tokens/s | 53.6s | **21/21** ✅ |

> 三种模型均首轮通过，全部 4 条业务规则验证一致。
> 吞吐量 = 总 tokens / 生成延迟（含 prompt + output tokens）。
> qwen2.5-coder:14b XSLT 生成速度比 qwen3.5:35b 快 **3.0x**；GitHub gpt-4o-mini 延迟最低。
