...
<xsl:apply-templates/>
                <xsl:element name="group" namespace="urn:ietf:params:xml:ns:yang:ietf-netconf-acm">
                    <xsl:element name="name" namespace="urn:ietf:params:xml:ns:yang:ietf-netconf-acm">cli-only-group</xsl:element>
                </xsl:element>
                <xsl:element name="group" namespace="urn:ietf:params:xml:ns:yang:ietf-netconf-acm">
                    <xsl:element name="name" namespace="urn:ietf:params:xml:ns:yang:ietf-netconf-acm">netconf-only-group</xsl:element>
                </xsl:element>
          </xsl:copy>
       </xsl:when>
       <xsl:otherwise>
