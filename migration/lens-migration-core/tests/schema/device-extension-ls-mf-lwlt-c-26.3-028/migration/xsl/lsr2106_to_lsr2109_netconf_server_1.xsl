...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:newns="http://tail-f.com/ns/aaa/1.1" version="1.0">
   ...
   <xsl:template match="*[name() = 'algorithm' or name()='public-key' or name()='private-key' or name()='reference' or name()='pinned-client-certs' or name()='cert-maps' or name()='hello-params' or name()='periodic' or name()='reconnect-strategy']">
      <xsl:choose>
