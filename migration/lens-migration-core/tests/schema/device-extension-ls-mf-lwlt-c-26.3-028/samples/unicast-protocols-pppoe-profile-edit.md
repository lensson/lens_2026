This macro creates a PPPoE Intermediate Agent profile.

Description:

* It configures PPPoE Intermediate Agent profile circuit-id, remote-id, start-numbering-from-zero, use-leading-zeros, access-loop-characteristics (TLV 0x90 is a detail).
...
* The sub-tag must include at least one of the above keywords. The constructed circuit-id or remote-id sub-tags should not exceed 63 characters. If exceeded, only the first 63 characters will be included part of the circuit-id or remote-id sub-tags.
...
* access-loop-characteristics: Access loop characteristics to be added in the vendor-specific tag
...
* pppoe-profile-name: Name of the PPPoE Intermediate Agent profile
