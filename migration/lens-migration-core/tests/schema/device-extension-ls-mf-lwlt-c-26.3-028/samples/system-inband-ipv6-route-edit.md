This macro configures static inband management IPv6 address, route and vlan.

Pre-condition:

The following default configuration must be available before inband IPv6 address, route and vlan can be configured.
...
* ipv6-address: Inband interface IPv6 address
