This macro configures Connectivity Fault Management (CFM) in RB mode in a network 
...
* onu-name: ONU name
* overrule-mep-id: New MEP-id to overwrite which is a key for maintenance association end point
