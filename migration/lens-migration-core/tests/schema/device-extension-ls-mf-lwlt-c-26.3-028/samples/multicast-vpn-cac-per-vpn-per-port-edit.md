Configure multicast CAC attributes on channel pair, eth or lag for a multicast vpn.

Prerequisites:

* The channel pair,eth or lag must be created.
...
* interface-name: The name of a channel pair,eth,or lag.
