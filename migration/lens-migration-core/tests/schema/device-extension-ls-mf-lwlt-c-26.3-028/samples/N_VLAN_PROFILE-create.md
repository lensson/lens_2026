This macro creates a user vlan frame processing profile for CC.
...
* skip-pbit-dei-marking: If this is set to true, then the pbit and DEI values will not be copied to the marking-list.
