This macro configures static IPv6 address, route and vlan for the secondary inband management interface.

Pre-condition:

The following default configuration must be available before IPv6 address, route and vlan can be configured.
...
* ipv6-address: Secondary inband interface IPv6 address
* l2-term-interface: Name of l2 termination interface
* prefix-length: The length of the subnet prefix
* route6-dest-prefix: IPv6 destination prefix
* route6-next-hop: Route next-hop
* vlan-id: Vlan value
