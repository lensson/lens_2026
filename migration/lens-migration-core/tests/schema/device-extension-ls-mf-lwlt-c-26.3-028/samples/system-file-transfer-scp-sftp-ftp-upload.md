This macro uploads the specified file to a SFTP, SCP or FTP server with username/password based authentication.
...
* host-url: sftp, scp or ftp server url. Note that a URL that does not end with a forward slash / will modify the name of the final compressed file that is to be uploaded.
* password: password
