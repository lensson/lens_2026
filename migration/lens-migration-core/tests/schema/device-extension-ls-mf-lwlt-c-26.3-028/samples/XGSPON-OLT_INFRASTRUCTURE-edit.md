This macro edits an XGSPON infrastructure in the OLT on which XGSPON ONUs can be attached.
...
* burst-overhead: This is the physical layer overhead (PLOu).
...
* xgs-pon-id: The PON identifier of this channel-termination.
