This macro can be used for retrieving an EST CA certificate's attributes:
...
EST CAs are configured with the macro system-est-client-edit and they can be referenced by other yang models.
...
* certificate-name: Certificate name. Can be omitted to view all the CAs for a profile.
